...
{
  echo '<h1>Create Request Form</h1>' ;
}
else
{
echo '<h1>Appointment Form</h1>'; 
}
?>

<form method="post" action="ProcessAppointment.php" onsubmit="return validate(this);">
...
<tr>
	<td> Check this box if your pet is neutered/spayed:</td>
	<td colspan="2">
